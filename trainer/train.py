...
def train(config: Config, model, optimizer, train_prefetcher):
    ...
    with open(log_file_path, "a") as f:
        ...
        f.write(f"encoder transformer layer: {config.num_encoder_transformer_layers}\n")
        f.write(f"decoder transformer layer: {config.num_decoder_transformer_layers}\n")
        f.write(f"heads: {config.num_heads}, groups: {config.num_groups}\n\n")
